...
function SearchDoctor() {
  ...
  const handleAllSearch = async () => {
    try {
      const response = await axios.post('https://patient-and-health-insurance-management.onrender.com/view_all_doctors/', { searchAll});
  ...
  const handleCovidSupportSearch = async() => {
    try {
      const response = await axios.post('https://patient-and-health-insurance-management.onrender.com/view_all_doctors/', { searchCovidSupport});
  ...
  const handleSpecialtySearch = async() => {
    try {
      const response = await axios.post('https://patient-and-health-insurance-management.onrender.com/search_by_specialization/', { searchSpecialty });
      navigate('/search-doctor-results', { state: { results: response?.data } });
    } catch (error) {
      console.error('Error:', error);
    }
